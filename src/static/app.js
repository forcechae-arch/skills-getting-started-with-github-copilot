        ...
        const participantsMarkup = participants.length
          ? participants.map((email) => `
              <li class="participants-item">
                ...
                <button type="button" class="participant-delete" data-email="${email}" aria-label="Remove ${email}">✕</button>
              </li>
            `).join("")
          : '<li class="participants-item participants-empty">No participants yet</li>';
